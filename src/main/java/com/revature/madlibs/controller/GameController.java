...
//	}
	...
	public ResponseEntity<CompletedStories> saveCompletedStory(@RequestBody CompletedStoryFront storyFront) {
		...
		CompletedStories returnStory;
		CompletedStories story = new CompletedStories(storyFront.getCompletedStory(),
				service.getUserById(storyFront.getUserId()),
				service.getOneIncompleteStoryById(storyFront.getParentStory()));
